    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a new simulation instance and load the simulation world parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Generate agent profiless</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Use context and graph tools to extract entities and relationships, initialize simulated participants, and seed them with distinct behaviors and memories.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Current Seed Topic Count</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">Generated agent profiless</span>
            </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM configures world time scaling, recommendation logic, active hours, posting frequency, and event triggers from the scenario and real-world seed.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Automatically generate seed events and hot topics to shape the initial state of the simulation world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The simulation environment is ready. You can start the simulation now.</p>
          
          <!-- Simulation round settings - only shown after configuration is generated and rounds are calculated -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Round Settings</span>
                <span class="section-desc">MiroFish automatically plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of real-world progression, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>For 100 agents: estimated runtime is about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        For 100 agents: estimated runtime is {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If this is your first run, it is strongly recommended to switch to custom mode and reduce the round count for a faster preview and lower error risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="action-group dual">
            ...
            >
              Start Parallel Dual-World Simulation ➝
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="SelectedProfile" class="profile-modal-overlay" @click.self="SelectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Visible Event Age</span>
              <span class="info-value">{{ SelectedProfile.age || '-' }} years old</span>
            </div>
            <div class="info-item">
              <span class="info-label">Visible Event Gender</span>
            ...
            <div class="info-item">
              <span class="info-label">Visible Event MBTI</span>
          ...
          <div class="modal-section">
            ...
            <p class="section-bio">{{ SelectedProfile.bio || 'No summary yet' }}</p>
          </div>
          ...
          <div class="modal-section" v-if="SelectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">The complete behavioral path within this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral Pattern Profile</span>
                <span class="dim-desc">Summarized experience and style preferences</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">A map of personal links and interactions</span>
              </div>
            </div>
...
// State
const phase = ref(0) // 0: Initialize, 1: Generate profiles, 2: Generate config, 3: Complete
...
// Log deduplication: keep track of the last key message that was printed.
let lastLoggedMessage = ''
let lastLoggedProfileCount = 0
let lastLoggedConfigStage = ''

// Simulation round settings
const useCustomRounds = ref(false) // Use automatic rounds by default.
const customMaxRounds = ref(40)   // Recommended default: 40 rounds.

// Watch stage to update phase
watch(currentStage, (newStage) => {
  if (newStage === 'Generate agent profiless' || newStage === 'generating_profiles') {
    phase.value = 1
  } else if (newStage === 'Generate Simulation Config' || newStage === 'generating_config') {
    phase.value = 2
    // Enter the config generation stage and start polling.
    if (!configTimer) {
    ...
    phase.value = 2 // Still part of the configuration stage.
  }
})

// Compute automatically generated rounds from the config instead of using a hard-coded default.
const autoGeneratedRounds = computed(() => {
  if (!simulationConfig.value?.time_config) {
    return null // Return null until configuration is available.
  }
  ...
  // Keep the maximum at or above the recommended 40 rounds.
...
// Get the username for a given agent ID.
...
// Count all linked topics across generated profiles.
...
const handleStartSimulation = () => {
  // Build parameters to send back to the parent component.
  const params = {}
  
  if (useCustomRounds.value) {
    // User-defined round count.
    params.maxRounds = customMaxRounds.value
    addLog(`Starting simulation with custom rounds: ${customMaxRounds.value}`)
  } else {
    // Keep the automatically generated round count.
...
// Start simulation preparation automatically.
const startPrepareSimulation = async () => {
  ...
  // Mark the first step as done and begin the second step.
  phase.value = 1
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected existing completed preparation. Reusing it directly.')
      ...
      // Store the expected total agent count immediately from the prepare response.
      ...
      startPolling()
      // Begin fetching profiles in real time.
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Parse stage information and print detailed logs.
      if (data.progress_detail) {
        currentStage.value = data.progress_detail.current_stage_name || ''
        
        // Print detailed progress logs while avoiding duplicates.
        ...
        // Print the message if it has not already been logged.
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only update when the API returns a valid value.
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        // Log when all profiles have been generated.
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Log config-generation stage changes without duplicates.
      ...
      // Apply the generated configuration once it is ready.
      if (data.config_generated && data.config) {
        simulationConfig.value = data.config
        addLog('✓ Simulation configuration generated')
        
        // Show a detailed configuration summary.
        if (data.summary) {
        ...
        // Show event configuration details.
...
const loadPreparedData = async () => {
  ...
  // Fetch config through the real-time endpoint.
  try {
    const res = await getSimulationConfigRealtime(props.simulationId)
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // Configuration is still being generated, so continue polling.
        addLog('Configuration is still being generated. Waiting via polling...')
        startConfigPolling()
      }
    }
  } catch (err) {
...
onMounted(() => {
  // Start the preparation flow automatically.
  if (props.simulationId) {
