 ...
 * @param {string} simulationId
 * @returns {Promise} Returns configuration data including metadata and config content.
 */
...
/**
 * Get detailed run status, including recent actions.
 * @param {string} simulationId
 */
...
/**
 * Get historical simulations, including project details.
