"""
action logger
For recording each Agent's actions during OASIS simulation, used for backend monitoring
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: The base path of the simulation directory
        """
...
class ActionLogger:
    """
    Action logger (compatible with old interfaces)
...
# Global log instance (compatible with old interfaces)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get global log instance (compatible with old interfaces)"""
